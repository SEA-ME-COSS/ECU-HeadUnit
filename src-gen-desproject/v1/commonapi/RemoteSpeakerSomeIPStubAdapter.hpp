...
public:
    ...
    {
        RemoteSpeakerSomeIPStubAdapterHelper::addStubDispatcher( { CommonAPI::SomeIP::method_id_t(0x7c) }, &setGearStubDispatcher );
        RemoteSpeakerSomeIPStubAdapterHelper::addStubDispatcher( { CommonAPI::SomeIP::method_id_t(0x7d) }, &setDistanceStubDispatcher );
