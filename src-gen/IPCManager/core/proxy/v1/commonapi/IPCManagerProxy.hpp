...
public:
     ...
     * will be set.
     */
    virtual void setSensorRpm(uint16_t _SensorRpm, CommonAPI::CallStatus &_internalCallStatus, std::string &_messag, const CommonAPI::CallInfo *_info = nullptr);
    /**
...
template <typename ... _AttributeExtensions>
void IPCManagerProxy<_AttributeExtensions...>::setSensorRpm(uint16_t _SensorRpm, CommonAPI::CallStatus &_internalCallStatus, std::string &_messag, const CommonAPI::CallInfo *_info) {
    delegate_->setSensorRpm(_SensorRpm, _internalCallStatus, _messag, _info);
}
